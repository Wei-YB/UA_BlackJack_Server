...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_client_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::proxy::Request, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::proxy::Request, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::proxy::Request, requesttype_),
  PROTOBUF_FIELD_OFFSET(::proxy::Request, uid_),
  PROTOBUF_FIELD_OFFSET(::proxy::Request, stamp_),
  PROTOBUF_FIELD_OFFSET(::proxy::Request, args_),
  2,
  0,
  1,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::proxy::Response, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::proxy::Response, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::proxy::Response, status_),
  PROTOBUF_FIELD_OFFSET(::proxy::Response, uid_),
  PROTOBUF_FIELD_OFFSET(::proxy::Response, stamp_),
  PROTOBUF_FIELD_OFFSET(::proxy::Response, args_),
  0,
  1,
  2,
  ~0u,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, sizeof(::proxy::Request)},
  { 13, 22, sizeof(::proxy::Response)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::proxy::_Request_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::proxy::_Response_default_instance_),
};

const char descriptor_table_protodef_client_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014client.proto\022\005proxy\"\206\004\n\007Request\0224\n\013req"
  "uestType\030\001 \001(\0162\032.proxy.Request.RequestTy"
  "peH\000\210\001\001\022\020\n\003uid\030\002 \001(\003H\001\210\001\001\022\022\n\005stamp\030\003 \001(\003"
  ...
  "\022\022\021\n\rACCEPT_FRIEND\020\023\022\021\n\rDELETE_FRIEND\020\024\022"
  "\017\n\013LIST_FRIEND\020\025\022\016\n\nLIST_MATCH\020\026\022\021\n\rLIST"
  "_WAITTING\020\027\022\017\n\013NOTIFY_USER\020\030B\016\n\014_request"
  "TypeB\006\n\004_uidB\010\n\006_stamp\"p\n\010Response\022\023\n\006st"
  "atus\030\001 \001(\003H\000\210\001\001\022\020\n\003uid\030\002 \001(\003H\001\210\001\001\022\022\n\005sta"
  "mp\030\003 \001(\003H\002\210\001\001\022\014\n\004args\030\004 \003(\tB\t\n\007_statusB\006"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_client_2eproto = {
  false, false, 664, descriptor_table_protodef_client_2eproto, "client.proto", 
  &descriptor_table_client_2eproto_once, nullptr, 0, 2,
...
Request::Request(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:proxy.Request)
}
Request::Request(const Request& from)
  ...
  // @@protoc_insertion_point(copy_constructor:proxy.Request)
}
...
Request::~Request() {
  // @@protoc_insertion_point(destructor:proxy.Request)
  SharedDtor();
...
void Request::Clear() {
// @@protoc_insertion_point(message_clear_start:proxy.Request)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_requesttype(static_cast<::proxy::Request_RequestType>(val));
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          do {
            ...
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "proxy.Request.args"));
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* Request::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:proxy.Request)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proxy.Request)
  return target;
}

size_t Request::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:proxy.Request)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:proxy.Request)
  GOOGLE_DCHECK_NE(&from, this);
  const Request* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Request>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:proxy.Request)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:proxy.Request)
    MergeFrom(*source);
  }
}

void Request::MergeFrom(const Request& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:proxy.Request)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:proxy.Request)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:proxy.Request)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
Response::Response(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:proxy.Response)
}
Response::Response(const Response& from)
  ...
  // @@protoc_insertion_point(copy_constructor:proxy.Response)
}
...
Response::~Response() {
  // @@protoc_insertion_point(destructor:proxy.Response)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void Response::Clear() {
// @@protoc_insertion_point(message_clear_start:proxy.Response)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          do {
            ...
            auto str = _internal_add_args();
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "proxy.Response.args"));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<34>(ptr));
        } else goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8* Response::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:proxy.Response)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proxy.Response)
  return target;
}

size_t Response::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:proxy.Response)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:proxy.Response)
  GOOGLE_DCHECK_NE(&from, this);
  const Response* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Response>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:proxy.Response)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:proxy.Response)
    MergeFrom(*source);
  }
}

void Response::MergeFrom(const Response& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:proxy.Response)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:proxy.Response)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:proxy.Response)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::proxy::Request* Arena::CreateMaybeMessage< ::proxy::Request >(Arena* arena) {
  return Arena::CreateMessageInternal< ::proxy::Request >(arena);
}
template<> PROTOBUF_NOINLINE ::proxy::Response* Arena::CreateMaybeMessage< ::proxy::Response >(Arena* arena) {
  return Arena::CreateMessageInternal< ::proxy::Response >(arena);
}
