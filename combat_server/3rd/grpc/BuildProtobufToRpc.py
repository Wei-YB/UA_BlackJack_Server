...
os.system("cp ./UA_BlackJack.grpc.pb.cc ../../grpc_cpp")
os.system("cp ./UA_BlackJack.pb.cc ../../grpc_cpp")
os.system("cp ./UA_BlackJack.grpc.pb.h ../../grpc_h")
os.system("cp ./UA_BlackJack.pb.h ../../grpc_h")