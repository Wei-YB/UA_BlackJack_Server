...
static const char* UserService_method_names[] = {
  "/ua_blackjack.UserService/Notify",
};
...
::grpc::Status UserService::Stub::Notify(::grpc::ClientContext* context, const ::ua_blackjack::Request& request, ::ua_blackjack::Response* response) {
  return ::grpc::internal::BlockingUnaryCall< ::ua_blackjack::Request, ::ua_blackjack::Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_Notify_, context, request, response);
}

void UserService::Stub::experimental_async::Notify(::grpc::ClientContext* context, const ::ua_blackjack::Request* request, ::ua_blackjack::Response* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::ua_blackjack::Request, ::ua_blackjack::Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Notify_, context, request, response, std::move(f));
}

void UserService::Stub::experimental_async::Notify(::grpc::ClientContext* context, const ::ua_blackjack::Request* request, ::ua_blackjack::Response* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Notify_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::ua_blackjack::Response>* UserService::Stub::PrepareAsyncNotifyRaw(::grpc::ClientContext* context, const ::ua_blackjack::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::ua_blackjack::Response, ::ua_blackjack::Request, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_Notify_, context, request);
}

::grpc::ClientAsyncResponseReader< ::ua_blackjack::Response>* UserService::Stub::AsyncNotifyRaw(::grpc::ClientContext* context, const ::ua_blackjack::Request& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncNotifyRaw(context, request, cq);
  result->StartCall();
  return result;
...
UserService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< UserService::Service, ::ua_blackjack::Request, ::ua_blackjack::Response, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](UserService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::ua_blackjack::Request* req,
             ::ua_blackjack::Response* resp) {
...
::grpc::Status UserService::Service::Notify(::grpc::ServerContext* context, const ::ua_blackjack::Request* request, ::ua_blackjack::Response* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
