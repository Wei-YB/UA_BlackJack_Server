...
char* ua_blackjack::data_base_server::name_format::GetKey(FormatType type, int64_t input) {
...
char* ua_blackjack::data_base_server::name_format::GetKey(FormatType type, const char* input) {
...
char* ua_blackjack::data_base_server::name_format::GetKey(FormatType type) {
    switch (type) {
