...
char* ua_black_jack_server::DataBaseServer::nameFormat::GetKey(FormatType type, int64_t input) {
...
char* ua_black_jack_server::DataBaseServer::nameFormat::GetKey(FormatType type, const char* input) {
...
char* ua_black_jack_server::DataBaseServer::nameFormat::GetKey(FormatType type) {
    switch (type) {
